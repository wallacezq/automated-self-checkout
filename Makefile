...
benchmark-stream-density: build-benchmark download-models
	cd performance-tools/benchmark-scripts && python benchmark.py --compose_file ../../src/docker-compose.yml --target_fps $(TARGET_FPS) --container_names="testname" --density_increment 1 --results_dir $(RESULTS_DIR)
